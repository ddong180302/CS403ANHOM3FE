...
import { createNhanKhau } from "../../services/apiServices";
import {
    Modal,
    Button,
    Typography,
...
const ModalCreateNhanKhau = (props) => {
    ...
    const resetForm = () => {
        ...
        setNgheNghiep("");
        setHoKhauID("");
        setDiaChiTruocKhiChuyenDen("");
        setDanToc("");
        setNgayCapCCND_CCDC("");
    };
    const handleCreateNhanKhau = async () => {
        const dataCreateNhanKhau = {
            HoTen,
            BiDanh,
            NgayThangNamSinh,
            NoiSinh,
        ...
        let data = await createNhanKhau(dataCreateNhanKhau);
        if (data) {
                    ...
                    <Typography id="modal-modal-description" sx={{ mt: 2, maxHeight: '60vh', overflow: 'auto' }}>
                        <div className='infor'>
                            ...
                            <div className='div-input'>
                                <input className='input' type="text" onChange={(event) => setHoTen(event.target.value)} />
                            </div>
                        </div>
                        <div className='infor'>
                            <div className='div-label'>
                            ...
                            <div className='div-input'>
                                <input className='input' type="text" onChange={(event) => setBiDanh(event.target.value)} />
                            </div>
                        </div>
                        <div className='infor'>
                            <div className='div-label'>
                            ...
                            <div className='div-input'>
                                <input className='input' type="date" onChange={(event) => setNgayThangNamSinh(event.target.value)} />
                            </div>
                        </div>
                        <div className='infor'>
                            <div className='div-label'>
                        ...
                        <div className='infor'>
                            ...
                            <div className='div-input'>
                                <input className='input' type="text" onChange={(event) => setNoiLamViec(event.target.value)} />
                            </div>
                        </div>
                        <div className='infor'>
                            <div className='div-label'>
                            ...
                            <div className='div-input'>
                                <input className='input' type="text" onChange={(event) => setQuanHeVoiChuHo(event.target.value)} />
                            </div>
                        </div>
                        <div className='infor'>
                            <div className='div-label'>
                            ...
                            <div className='div-input'>
                                <input className='input' type="text" onChange={(event) => setSoCMND_CCDC(event.target.value)} />
                            </div>
                        </div>
                        ...
                        <div className='infor'>
                            ...
                            <div className='div-input'>
                                <input className='input' type="text" onChange={(event) => setNgheNghiep(event.target.value)} />
                            </div>
                        </div>
                        ...
                        <div className='infor'>
                            ...
                            <div className='div-input'>
                                <select className='input' id="HoKhauID" type="number" value={HoKhauID} onChange={(event) => setHoKhauID(event.target.value)}>
                                    <option value="">-- Chọn ID Hộ Khẩu --</option>
                        ...
                        <div className='infor'>
                            ...
                            <div className='div-input'>
                                <input className='input' type="date" onChange={(event) => setNgayCapCCND_CCDC(event.target.value)} />
                            </div>
                        </div>
                    </Typography>
                    <Typography id="modal-modal-description" sx={{ mt: 2, display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-end' }}>
                        <Button variant="contained" onClick={() => handleCreateNhanKhau()} sx={{ marginRight: '10px' }}>Thêm Mới</Button>
...
export default ModalCreateNhanKhau;